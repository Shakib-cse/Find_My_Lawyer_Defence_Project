...
session_start();
$lawyer_email = $_SESSION['email_send'];
$lawyer_otp = $_SESSION['otp_send'];



if (isset($_POST['lawyer_submit'])) {

    $current_otp = $_POST['this_lawyer_otp'];

        if($lawyer_otp == $current_otp){
            header("Location: asAlawyer.php");
            exit();
        }else{
...
<head>
    ...
    <!-- css stylesheet link -->
    <link rel="stylesheet" href="./style/asAlawyer1.css">
</head>
...
<body>
    <div class="form-area">
        ...
        <div class="container">
            ...
            <form action="asAlawyer1.php" method="POST">
                <div class="all-form">
                    <div class="box-section">
                        <label class="box-label" for="email">
                            <h3>We sent you OTP in your Email</h3>
                        </label>
                        <input class="box-input" type="number" name="this_lawyer_otp" id="otp"
                            placeholder="Enter Your OTP*" required>
                    </div>
                    <div class="btn-area">
                        <button class="all-btn" type="submit" name="lawyer_submit">Submit</button>
