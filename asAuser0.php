...
if (isset($_POST['user_submit'])) {
    ...
    if ($count > 0) {
        ...
        echo smtp_mailer($receivermail, $subject, $emailbody . $otp);
            ...
            session_start();
            $_SESSION['user_email_send'] = $user_email;
            $_SESSION['user_otp_send'] = $otp;
            header("Location: asAuser1.php");
            exit();
        }
    }
...
<head>
    ...
    <!-- css stylesheet link -->
    <link rel="stylesheet" href="./style/asAuser0.css">
</head>
...
<body>
    <div class="form-area">
        ...
        <div class="container">
            ...
            <form action="asAuser0.php" method="POST">
                <div class="all-form">
                    <div class="box-section">
                        <!-- <label class="box-label" for="email"><strong>Email</strong> <span class="mendatory">*</span></label> -->
                        <input class="box-input" type="email" name="user_email" id="email" placeholder="Email*"
                            required>
                    </div>
                    <div class="btn-area">
