    ...
    <main style="padding-top:150px;padding-bottom:100px;background:wheat;">
        <div class="lawyer_area">
            ...
            <div class="filter-search">
                    ...
                    <form action="login_lawyer_list.php" method="post">
                ...
                <div class="lawyer-item">
                    ...
                    if ($lawyer_show_result->num_rows > 0) {
                        ...
                        <button type='submit' class='all-btn' name='get_lawyer_info'>View Profile</button>
                            ...
                            $query = "SELECT * FROM lawyer_reg WHERE lawyer_prectice_area LIKE '%$searchQuery%' OR lawyer_prectice_location LIKE '%$searchQuery%' OR lawyer_name LIKE '%$searchQuery%' OR onlineOrOffline LIKE '%$searchQuery%'";
