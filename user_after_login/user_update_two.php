...
if (isset($_POST['user_update'])) {
    ...
    $user_update_sql = "UPDATE user_reg SET user_phone='$user_phone', user_work='$user_work', user_nid_number='$user_nid_number', user_age='$user_age', user_gender='$user_gender' WHERE user_email='$current_email'";
...
<head>
    ...
    <!-- css stylesheet link -->
    <link rel="stylesheet" href="../style/user_update_two.css">
</head>
        ...
        <div class="update-area">
            <div class="container overflow-hidden">
                <div class="update-item text-center">
                    <form action="user_update_two.php" method="POST">
                        <div class="item mb-3">
                            <label class="d-block fs-5 text-decoration-underline mb-1 fw-bold"
                                for="user_phone">Phone</label>
                            <input class="w-100 p-2 border-0 rounded text-center" type="number" id="user_phone"
                                name="user_phone" value="0<?php echo $user_data['user_phone']; ?>" pattern="\d{11}">
                        </div>
                        <div class="item mb-3">
                            <label class="d-block fs-5 text-decoration-underline mb-1 fw-bold" for="user_work">User
                                Work</label>
                            <input class="w-100 p-2 border-0 rounded text-center" type="text" id="user_work"
                                name="user_work" value="<?php echo $user_data['user_work']; ?>">
                        </div>
                        <div class="item mb-3">
                            <label class="d-block fs-5 text-decoration-underline mb-1 fw-bold"
                                for="user_nid_number">User NID/Birth Number</label>
                            <input class="w-100 p-2 border-0 rounded text-center" type="number" id="user_nid_number"
                                name="user_nid_number" value="<?php echo $user_data['user_nid_number']; ?>">
                        </div>
                        <div class="item mb-3">
                            <label class="d-block fs-5 text-decoration-underline mb-1 fw-bold" for="user_age">User
                                Age</label>
                            <input class="w-100 p-2 border-0 rounded text-center" type="text" id="user_age"
                                name="user_age" value="<?php echo $user_data['user_age']; ?>">
                        </div>
                        <div class="item mb-3">
                            <label class="d-block fs-5 text-decoration-underline mb-1 fw-bold" for="user_gender">User
                                Gender</label>
                            <input class="w-100 p-2 border-0 rounded text-center" type="text" id="user_gender"
                                name="user_gender" value="<?php echo $user_data['user_gender']; ?>">
                        </div>
